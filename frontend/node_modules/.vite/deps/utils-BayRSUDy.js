import { a as __toESM, i as __toCommonJS, n as __esmMin, r as __exportAll, t as __commonJSMin } from "./rolldown-runtime-7_rZTKki.js";
import { t as require_react } from "./react.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { n as init_clsx, t as clsx } from "./clsx-BD0tU_fe.js";
...
function deepClone(source) {
	if (/*#__PURE__*/ import_react$23.isValidElement(source) || !isPlainObject(source)) return source;
	const output = {};
...
function deepmerge(target, source, options = { clone: true }) {
	...
	if (isPlainObject(target) && isPlainObject(source)) Object.keys(source).forEach((key) => {
		if (/*#__PURE__*/ import_react$23.isValidElement(source[key])) output[key] = source[key];
...
var import_prop_types$8, elementAcceptingRef;
var init_elementAcceptingRef$1 = __esmMin((() => {
	import_prop_types$8 = /* @__PURE__ */ __toESM(require_prop_types());
	init_chainPropTypes();
	elementAcceptingRef = chainPropTypes(import_prop_types$8.default.element, acceptingRef);
	elementAcceptingRef.isRequired = chainPropTypes(import_prop_types$8.default.element.isRequired, acceptingRef);
}));
//#endregion
...
var import_prop_types$7, refType;
var init_refType$1 = __esmMin((() => {
	import_prop_types$7 = /* @__PURE__ */ __toESM(require_prop_types());
	refType = import_prop_types$7.default.oneOfType([import_prop_types$7.default.func, import_prop_types$7.default.object]);
}));
//#endregion
...
function isMuiElement(element, muiNames) {
	...
	return /*#__PURE__*/ import_react$22.isValidElement(element) && muiNames.indexOf((_muiName = element.type.muiName) != null ? _muiName : (_element$type = element.type) == null || (_element$type = _element$type._payload) == null || (_element$type = _element$type.value) == null ? void 0 : _element$type.muiName) !== -1;
}
var import_react$22;
...
var import_react$21, useEnhancedEffect;
var init_useEnhancedEffect$2 = __esmMin((() => {
	import_react$21 = /* @__PURE__ */ __toESM(require_react());
	useEnhancedEffect = typeof window !== "undefined" ? import_react$21.useLayoutEffect : import_react$21.useEffect;
}));
//#endregion
...
function useGlobalId(idOverride) {
	const [defaultId, setDefaultId] = import_react$20.useState(idOverride);
...
var import_react$20, globalId, maybeReactUseId;
var init_useId$2 = __esmMin((() => {
	import_react$20 = /* @__PURE__ */ __toESM(require_react());
	globalId = 0;
	maybeReactUseId = import_react$20["useId".toString()];
}));
//#endregion
...
function useControlled({ controlled, default: defaultProp, name, state = "value" }) {
	const { current: isControlled } = import_react$19.useRef(controlled !== void 0);
	const [valueState, setValue] = import_react$19.useState(defaultProp);
	const value = isControlled ? controlled : valueState;
	{
		...
		const { current: defaultValue } = import_react$19.useRef(defaultProp);
		import_react$19.useEffect(() => {
	...
	return [value, import_react$19.useCallback((newValue) => {
...
function useEventCallback(fn) {
	const ref = import_react$18.useRef(fn);
	useEnhancedEffect(() => {
		ref.current = fn;
	});
	return import_react$18.useRef((...args) => (0, ref.current)(...args)).current;
}
var import_react$18;
...
function useLazyRef(init, initArg) {
	const ref = import_react$16.useRef(UNINITIALIZED);
	if (ref.current === UNINITIALIZED) ref.current = init(initArg);
	return ref;
}
var import_react$16, UNINITIALIZED;
...
function useOnMount(fn) {
	import_react$15.useEffect(fn, EMPTY);
}
var import_react$15, EMPTY;
...
function useIsFocusVisible() {
	const ref = import_react$14.useCallback((node) => {
		if (node != null) prepare(node.ownerDocument);
	}, []);
	const isFocusVisibleRef = import_react$14.useRef(false);
	/**
...
var import_react$14, hadKeyboardEvent, hadFocusVisibleRecently, hadFocusVisibleRecentlyTimeout, inputTypesWhitelist;
...
function getReactElementRef(element) {
	if (parseInt(import_react$12.version, 10) >= 19) {
		var _element$props;
...
function DefaultPropsProvider$1({ value, children }) {
	return /*#__PURE__*/ (0, import_jsx_runtime$6.jsx)(PropsContext.Provider, {
		value,
		children
	});
}
...
function useDefaultProps$1({ props, name }) {
	return getThemeProps({
		props,
		name,
		theme: { components: import_react$11.useContext(PropsContext) }
	});
}
var import_react$11, import_prop_types$6, import_jsx_runtime$6, PropsContext;
var init_DefaultPropsProvider$3 = __esmMin((() => {
	...
	PropsContext = /*#__PURE__*/ import_react$11.createContext(void 0);
...
function DefaultPropsProvider(props) {
	return /*#__PURE__*/ (0, import_jsx_runtime$5.jsx)(DefaultPropsProvider$1, _extends({}, props));
}
function useDefaultProps(params) {
	return useDefaultProps$1(params);
}
var import_prop_types$5, import_jsx_runtime$5;
var init_DefaultPropsProvider$1 = __esmMin((() => {
	...
	DefaultPropsProvider.propTypes = {
		...
		* @ignore
		*/
		value: import_prop_types$5.default.object.isRequired
	};
}));
//#endregion
...
var import_react$9, syncFallback, useInsertionEffect, useInsertionEffectAlwaysWithSyncFallback, useInsertionEffectWithLayoutFallback;
...
function StyledEngineProvider(props) {
	...
	if (injectFirst || enableCssLayer) return /*#__PURE__*/ (0, import_jsx_runtime$4.jsx)(CacheProvider, {
		value: cache,
		children
	});
	return children;
}
var import_react$3, import_prop_types$4, import_jsx_runtime$4, cacheMap;
...
function GlobalStyles(props) {
	...
	return /*#__PURE__*/ (0, import_jsx_runtime$3.jsx)(Global, { styles: typeof styles === "function" ? (themeInput) => styles(isEmpty(themeInput) ? defaultTheme : themeInput) : styles });
}
var import_prop_types$3, import_jsx_runtime$3;
		...
		function traverse(sxInput) {
			...
			Object.keys(sxObject).forEach((styleKey) => {
				...
				if (value !== null && value !== void 0) {
					if (typeof value === "object") {
						if (config[styleKey]) css = merge(css, getThemeValue(styleKey, value, theme, config));
						else {
...
function extendSxProp(props) {
	const { sx: inSx } = props, other = _objectWithoutPropertiesLoose(props, _excluded$5);
...
var require_createStyled = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var _capitalize = _interopRequireDefault((init_capitalize$1(), __toCommonJS(capitalize_exports)));
...
var import_colorManipulator, _excluded$4, light, dark;
...
var _excluded$3, caseAllCaps, defaultFontFamily;
...
var _excluded$2, easing, duration;
...
var init_svgIconClasses = __esmMin((() => {
	init_generateUtilityClasses();
	init_generateUtilityClass();
	svgIconClasses = generateUtilityClasses("MuiSvgIcon", [
		"root",
		"colorPrimary",
		"colorSecondary",
		"colorAction",
...
var import_react$1, import_prop_types, import_jsx_runtime$1, import_jsx_runtime$2, _excluded, useUtilityClasses, SvgIconRoot, SvgIcon;
...
//#endregion
export { duration as $, getScrollbarSize as $n, require_prop_types as $r, styled$1 as $t, debounce_default as A, generateUtilityClasses as An, debounce as Ar, styleFunctionSx as At, init_styled as B, init_resolveProps as Bn, init_HTMLElementType as Br, getValue as Bt, ownerWindow_default as C, init_getReactElementRef$1 as Cn, init_ownerWindow$2 as Cr, init_styleFunctionSx as Ct, isMuiElement_default as D, clamp as Dn, init_isMuiElement$1 as Dr, createTheme$1 as Dt, init_isMuiElement as E, init_clamp as En, ownerDocument as Er, init_createTheme$1 as Et, SvgIcon as F, ClassNameGenerator as Fn, capitalize as Fr, init_cssGrid as Ft, slotShouldForwardProp as G, visuallyHidden as Gn, init_getDisplayName$1 as Gr, init_breakpoints as Gt, init_rootShouldForwardProp as H, resolveProps as Hn, init_HTMLElementType$1 as Hr, getPath as Ht, init_SvgIcon$1 as I, init_ClassNameGenerator$1 as In, init_capitalize$2 as Ir, init_borders as It, defaultTheme as J, usePreviousProps as Jn, exactProp as Jr, createBreakpoints as Jt, identifier_default as K, init_usePreviousProps as Kn, require_react_is$1 as Kr, mergeBreakpointsInOrder as Kt, getSvgIconUtilityClass as L, init_composeClasses as Ln, init_refType as Lr, createSpacing as Lt, createSvgIcon as M, init_generateUtilityClass as Mn, createChainedFunction as Mr, init_defaultSxConfig as Mt, init_createSvgIcon as N, generateUtilityClass as Nn, init_createChainedFunction$2 as Nr, init_sizing as Nt, deprecatedPropType_default as O, init_clamp$1 as On, init_isMuiElement$2 as Or, init_createTheme$2 as Ot, init_SvgIcon as P, init_generateUtilityClass$1 as Pn, init_capitalize$1 as Pr, init_palette as Pt, init_createTheme as Q, init_getScrollbarSize as Qn, init_elementAcceptingRef$1 as Qr, internal_serializeStyles as Qt, init_svgIconClasses as R, composeClasses as Rn, init_refType$1 as Rr, init_createSpacing as Rt, init_ownerWindow as S, getReactElementRef as Sn, setRef as Sr, init_createMixins as St, ownerDocument_default as T, init_objectWithoutPropertiesLoose as Tn, init_ownerDocument$2 as Tr, init_extendSxProp as Tt, rootShouldForwardProp as U, init_visuallyHidden as Un, init_getDisplayName as Ur, init_style as Ut, styled as V, init_resolveProps$1 as Vn, HTMLElementType as Vr, init_spacing as Vt, init_slotShouldForwardProp as W, init_visuallyHidden$1 as Wn, getDisplayName as Wr, handleBreakpoints as Wt, createMuiTheme as X, getNormalizedScrollLeft as Xn, init_elementAcceptingRef as Xr, init_styled_engine as Xt, init_defaultTheme as Y, detectScrollType as Yn, init_exactProp$1 as Yr, init_createBreakpoints as Yt, createTheme as Z, init_scrollLeft$1 as Zn, elementAcceptingRef as Zr, internal_processStyles as Zt, useEnhancedEffect_default as _, init_createChainedFunction as _n, useId as _r, init_grey as _t, useIsFocusVisible_default as a, init_extends as ai, css as an, init_useTimeout$1 as ar, init_green as at, init_requirePropFactory as b, init_esm as bn, useEnhancedEffect as br, require_colorManipulator as bt, init_useEventCallback as c, init_chainPropTypes$1 as ci, ThemeContext as cn, init_useForkRef$2 as cr, blue as ct, useControlled_default as d, init_DefaultPropsProvider$1 as dn, useEventCallback as dr, orange as dt, init_deepmerge as ei, styled_engine_exports as en, init_getScrollbarSize$1 as er, easing as et, init_unsupportedProp as f, useDefaultProps as fn, init_useControlled$1 as fr, init_red as ft, init_useEnhancedEffect as g, createChainedFunction_default as gn, init_useId$2 as gr, grey as gt, useId_default as h, init_DefaultPropsProvider$3 as hn, init_useId$1 as hr, purple as ht, init_useIsFocusVisible as i, _extends as ii, init_StyledEngineProvider$1 as in, Timeout as ir, green as it, init_debounce as j, init_generateUtilityClasses$1 as jn, init_debounce$2 as jr, defaultSxConfig as jt, init_deprecatedPropType as k, init_generateUtilityClasses as kn, isMuiElement as kr, init_styleFunctionSx$1 as kt, useEventCallback_default as l, require_interopRequireDefault as li, init_emotion_element_489459f2_browser_development_esm as ln, useForkRef as lr, init_blue as lt, init_useId as m, DefaultPropsProvider$1 as mn, useControlled as mr, init_purple as mt, unstable_ClassNameGenerator as n, init_deepmerge$1 as ni, init_GlobalStyles$1 as nn, useIsFocusVisible as nr, createTypography as nt, init_useForkRef as o, init_chainPropTypes as oi, init_emotion_react_browser_development_esm as on, useTimeout as or, init_lightBlue as ot, unsupportedProp_default as p, init_DefaultPropsProvider$2 as pn, init_useControlled$2 as pr, red as pt, init_identifier as q, init_usePreviousProps$1 as qn, init_exactProp as qr, resolveBreakpointValues as qt, utils_exports as r, isPlainObject as ri, StyledEngineProvider as rn, init_useTimeout as rr, init_createTypography as rt, useForkRef_default as s, chainPropTypes as si, keyframes as sn, init_useForkRef$1 as sr, lightBlue as st, init_utils as t, deepmerge as ti, GlobalStyles as tn, init_useIsFocusVisible$2 as tr, init_createTransitions as tt, init_useControlled as u, init_DefaultPropsProvider as un, init_useEventCallback$2 as ur, init_orange as ut, init_setRef as v, capitalize_default as vn, init_useEnhancedEffect$1 as vr, common as vt, init_ownerDocument as w, _objectWithoutPropertiesLoose as wn, ownerWindow as wr, extendSxProp as wt, requirePropFactory_default as x, init_getReactElementRef as xn, init_setRef$2 as xr, createMixins as xt, setRef_default as y, init_capitalize as yn, init_useEnhancedEffect$2 as yr, init_common as yt, svgIconClasses as z, init_composeClasses$1 as zn, refType as zr, createUnarySpacing as zt };
